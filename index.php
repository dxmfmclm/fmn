...
<body>
    <div class="title">
        ...
        <h1 class="f_l"><a href="">版本号:1.0</a></h1>
        <div class="user f_r">
            <?php
            if($loginName != '未登录') {
    ...
    <div class="container">
        <div style="text-align:center" class="message">
            ...
            <h2><a style="color:orange" href=""><i>大熊猫聊天室</i></a><br>
            <strong><a style="color:lightblue" href="http://imlolicon.tk">Bybiyuehu🦊</a></strong></h2>
            <h1><a style="color:pink" href="http://imlolicon.tk/sponsor">打赏网站源代码作者👉</a></h1>
        </div>
    </div>
</body>
